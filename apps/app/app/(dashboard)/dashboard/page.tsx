    ...
    <div className="p-8">
      ...
      <div className="flex items-center gap-4 bg-[#5448EE]/10 border border-[#5448EE]/20 rounded-2xl px-5 py-4 mb-8">
        ...
        <div className="flex-1">
          <p className="text-sm font-medium text-white/80">8 herramientas disponibles · 2 en camino</p>
          <p className="text-xs text-white/40 mt-0.5">Stock, Presupuestos, Caja, Precios, Sueldos, Asistencia, Garantías y más.</p>
        </div>
