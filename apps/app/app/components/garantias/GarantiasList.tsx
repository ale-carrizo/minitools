  ...
  if (garantias.length === 0) {
    return (
      <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-10 text-center">
        ...
        <Link href="/dashboard/garantias/nuevo" className="inline-flex bg-[#5448EE] hover:bg-[#4438DE] text-white rounded-xl px-4 py-2.5 text-[13px] font-medium transition-colors">
          + Nueva garantía
        </Link>
      </div>
    )
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-[12px] font-medium transition-colors ${
                  active ? 'bg-[#5448EE] text-white' : 'bg-white/[0.05] text-white/45 hover:text-white/75'
                }`}
              >
                {label}
              </button>
